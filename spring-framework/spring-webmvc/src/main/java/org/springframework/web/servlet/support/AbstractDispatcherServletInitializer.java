...
public abstract class AbstractDispatcherServletInitializer extends AbstractContextLoaderInitializer {
	...
	protected void registerDispatcherServlet(ServletContext servletContext) {
		...
		WebApplicationContext servletAppContext = createServletApplicationContext(); //day03：创建Servlet容器
		...
		registration.addMapping(getServletMappings()); //day03：根据我们指定的DispatcherServlet的路径进行注册
	 ...
	 * @see #registerDispatcherServlet(ServletContext)  day03：使用这个模板方法继续定制
	 */
